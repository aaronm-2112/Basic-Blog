...
var UserSQLLiteRepo = /** @class */ (function () {
    ...
    UserSQLLiteRepo.prototype.update = function (user) {
        return __awaiter(this, void 0, void 0, function () {
            var db, queryProperties, queryValues, userEntries, entry, query, statement, row, updatedUser, e_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 7, , 8]);
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, db.run("UPDATE User SET profilePic = ? WHERE username = ?", "profile pic path", "First User")];
                    case 3:
                        row = _a.sent();
                        console.log(row);
