...
function login(app, userRepository) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            ...
            app.post('/login', function (req, res) { return __awaiter(_this, void 0, void 0, function () {
                var username, password, user, samePassword, jwtBearerToken, e_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            ...
                            return [4 /*yield*/, userRepository.find(username)];
                        case 1:
                            user = _a.sent();
