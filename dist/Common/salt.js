...
exports.generateUserSalt = generateUserSalt;
//uses bcrypt's algorithm to create a hash based off the salt
function generateUserHash(password, salt) {
    return __awaiter(this, void 0, void 0, function () {
        var hash;
        return __generator(this, function (_a) {
            switch (_a.label) {
...
exports.generateUserHash = generateUserHash;
function compareUserPassword(incomingPassword, userHash) {
    return __awaiter(this, void 0, void 0, function () {
        var samePassword;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bcrypt_1.default.compare(incomingPassword, userHash)];
                case 1:
                    samePassword = _a.sent();
                    return [2 /*return*/, samePassword];
            }
        });
    });
}
